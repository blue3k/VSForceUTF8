...
namespace VILICVANE.ForceUTF8
{
    ...
    public sealed class ForceUTF8Package : Package
    {
        ...
        static HashSet<string> stm_IgnoreExts = null;
        ...
        void documentEvents_DocumentSaved(Document document) {
            ...
            if (stm_IgnoreExts.Contains(path))
                return;
            ...
            if (reader.CurrentEncoding == Encoding.UTF8 || reader.CurrentEncoding == Encoding.UTF32 || reader.CurrentEncoding == Encoding.Unicode) {
                stream.Close();
                return;
            }
